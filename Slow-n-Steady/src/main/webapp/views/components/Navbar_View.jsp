                        ...
                        <div id="carouselExample" class="carousel slide">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="views/presentacion/1.png" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="views/presentacion/2.png" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="views/presentacion/3.png" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="views/presentacion/4.png" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="views/presentacion/5.png" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="views/presentacion/6.png" class="d-block w-100" alt="...">
                                </div>
                            </div>
